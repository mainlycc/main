...
<div class="pullquote"><p>Z pełnym przekonaniem polecamy współpracę z Mainly. Proces tworzenia wizualizatora przerósł nasze najśmielsze oczekiwania, efekt końcowy to prawdziwa, rzetelnie wykonana robota. Jesteśmy ogromnie zadowoleni, dlatego zasłużone 5★</p><p style="margin-top:14px;font-size:14px;color:var(--fg-dim);font-style:normal;">Julia S.</p></div>
...
<div class="tech-tags"><span>Next.js</span><span>TypeScript</span><span>AI Image Generation</span><span>Tailwind CSS</span></div>',
  case_study_data = '{"rezultaty":[{"v":2,"l":"tryby pracy: Scena (wnętrze) i Detal (listing)"},{"v":3,"l":"warianty generowane jednocześnie z jednego opisu"},{"v":0,"l":"sesji fotograficznych potrzebnych do nowego wariantu koloru"}],"proces":[],"dodatkowe":["Kąt kamery, kolor produktu i jego rozmiar w scenie ustawia się przed generowaniem.","Gotowe pliki idą prosto do katalogu i do listingów, bez obróbki w programie graficznym.","Nowy wariant kolorystyczny nie wymaga angażowania osoby znającej AutoCAD."],"opinia":{"cytat":"Z pełnym przekonaniem polecamy współpracę z Mainly. Proces tworzenia wizualizatora przerósł nasze najśmielsze oczekiwania, efekt końcowy to prawdziwa, rzetelnie wykonana robota. Jesteśmy ogromnie zadowoleni, dlatego zasłużone 5★","autor":"Julia S.","rola":""}}'::jsonb,
