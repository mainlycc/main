  ...
  return (
    <div className="min-h-screen text-white">
      <div className="container mx-auto px-6 py-24 max-w-5xl">
        ...
        <div className={`relative ${project.slug === "biblioteka-promptow" ? "h-[500px]" : "h-[600px]"} rounded-xl overflow-hidden mb-16`}>
          <Image
            src={project.image}
            alt={project.name}
            fill
            className={project.slug === "biblioteka-promptow" ? "object-cover object-top" : "object-cover"}
            priority
          />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 mb-16">
          <div className="lg:col-span-2">
            ...
            {/* Dodatkowe zdjęcie dla biblioteki promptów */}
            {project.slug === "biblioteka-promptow" && (
              <div className="relative w-full h-[400px] rounded-xl overflow-hidden mb-8">
                <Image
                  src="/bibliotekapromptow.png"
                  alt="Biblioteka Promptów - widok strony"
                  fill
