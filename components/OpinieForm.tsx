        ...
        <div className="mb-10">
          ...
          <div className="bg-zinc-950 border border-[#FA6503]/20 p-6 rounded-xl text-white">
            ...
            <div className="flex items-center">
              ...
              />
              <div>
                <p className="font-medium text-white">{previewName}</p>
                <p className="text-xs text-gray-400">{previewMeta}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-zinc-50/95 border border-zinc-200 rounded-2xl p-5 sm:p-6 text-sm text-zinc-800 mb-10 space-y-4 relative overflow-hidden">
          ...
          <div className="relative space-y-1">
            ...
            <p className="text-zinc-700">
              Będę bardzo wdzięczny, jeśli w swojej opinii wspomnisz chociaż o
              jednym z tych punktów:
            </p>
          </div>
          ...
          <div className="relative space-y-2">
            ...
            <p className="text-zinc-700 pl-7">
              Na przykład: czy jest szybka, intuicyjna w obsłudze, dobrze
              zaprojektowana, spełnia ustalone wcześniej założenia.
            </p>
          </div>
          ...
          <div className="relative space-y-2">
            ...
            <p className="text-zinc-700 pl-7">
              Możesz wspomnieć, jakie procesy usprawnił, co przyspieszył albo
          ...
          <div className="relative space-y-2">
            ...
            <p className="text-zinc-700 pl-7">
              Np. czy złapaliśmy wspólny vibe, jak wyglądała komunikacja, jak
              oceniasz dostępność i zaangażowanie z mojej strony.
            </p>
          </div>
          ...
          <div className="relative space-y-2">
            ...
            <p className="text-zinc-700 pl-7">
              Jedno-dwa zdania, komu szczególnie mogłaby się przydać taka
              współpraca i z jakiego powodu.
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <label
                ...
                className="text-sm font-medium text-zinc-800 leading-relaxed cursor-pointer py-1"
              >
                Wyrażam zgodę na wykorzystanie mojej opinii na stronie
                internetowej.
              </label>
            </div>
            ...
            <div className="flex items-start gap-3">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setZgodaCaseStudy(Boolean(checked))
                }
                className="mt-1"
              />
              <label
                ...
                className="text-sm font-medium text-zinc-800 leading-relaxed cursor-pointer py-1"
              >
                Wyrażam zgodę na przedstawienie wykonanego projektu jako case
                study i zaprezentowanie go w portfolio (bez ujawniania poufnych
                danych).
              </label>
            </div>
          </div>
          ...
          {wyslano === "error" && (
            <p className="text-sm text-red-600">
              Uzupełnij treść opinii i zaznacz zgodę na publikację, aby móc ją
              wysłać.
            </p>
          )}
